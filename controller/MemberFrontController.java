...
import baskeyCart.BaskeyCartMoveAction;
...
public class MemberFrontController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		} else if (command.equals("/orderPageSelectDetail.bk")) {//주문페이지 선택한 상품 수량 입력 요청
		...
		/***********************************************************************************************/
			...
			else if (command.equals("/baskeyCartList.bk")) {//장바구니 리스트
			...
			else if(command.equals("/basketCartQtyUp.bk")) {//'★★★★★★★★    장바구니 항목 수량 증가  ★★★★' 요청이면						
			...
			else if(command.equals("/basketCartQtyDown.bk")) {//'★★★★★★★★    장바구니 항목 수량 감소  ★★★★' 요청이면						
			...
			else if(command.equals("/basketMove.bk")) {//'★★★★★★★★    장바구니 쇼핑계속하기 눌렀을때 이동★★★★' 요청이면						
				action = new BaskeyCartMoveAction();		 
				try {
					forward = action.execute(request, response);
				}catch(Exception e) {
					e.printStackTrace();
