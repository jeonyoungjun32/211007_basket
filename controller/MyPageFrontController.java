...
public class MyPageFrontController extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response)
		...
		} else if (command.equals("/memberOrderPro.bg")) {// 
		...
		} else if (command.equals("/adminMemberListUpdateSuccess.bg")) {// 관리자 회원 전체 리스즈 조회 수정 성공 폼
			forward = new ActionForward();
			forward.setPath("mypage/adminMemberListUpdateSuccess.jsp");
		...
		} else if (command.equals("/adminProductListForm.bg")) {// 전체 폼
